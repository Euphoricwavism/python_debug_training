...
class Field(object):
    ...
    def __init__(self):
        ...
        self.frame = [[" " for _ in range(self.FRAME_WIDTH)] for _ in range(self.FRAME_HEIGHT)]
        self.field = [[random.choice(source_str) for _ in range(self.FIELD_WIDTH)] for _ in range(self.FIELD_HEIGHT)]
